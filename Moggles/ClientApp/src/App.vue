<template>
    <div>
        ...
        <modal v-if="showAddToggle" v-model="showAddToggle" title="Add Feature Toggle" :footer="false">
        ...
        <modal v-if="editAppModalIsActive" v-model="editAppModalIsActive" title="Edit Application" :footer="false">
            <edit-application :application="selectedApp" @close-app-edit-modal="showEditAppModal(false)" />
        </modal>

        <modal v-if="showDeleteAppConfirmation" v-model="showDeleteAppConfirmation" title="You are about to delete an application" :footer="false">
