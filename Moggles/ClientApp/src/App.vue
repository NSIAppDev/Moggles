<template>
    <div>
        ...
        <modal v-if="showErrorAlert" v-model="showErrorAlert" title="Error" :footer="false">
            <alert-error :error="error" :customErrorMessage="customErrorMessage" @cancel="showErrorAlert = false"></alert-error>
        </modal>
    </div>
</template>
<script>
